    ...
    public partial class QuestionPage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                rdbtnQn1.Items.Add(new ListItem(firsttext, firsttext));
                ...
                rdbtnQn2.Items.Add(new ListItem(firsttext, firsttext));
                ...
                rdbtnQn3.Items.Add(new ListItem(firsttext, firsttext));
                ...
                rdbtnQn4.Items.Add(new ListItem(firsttext, firsttext));
                ...
                rdbtnQn5.Items.Add(new ListItem(firsttext, firsttext));
                ...
                rdbtnQn7.Items.Add(new ListItem(firsttext, firsttext));
                ...
                rdbtnQn10.Items.Add(new ListItem(firsttext, firsttext));
